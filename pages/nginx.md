# nginx (engine x)
	...
	- ### Stream module
		...
		- This adds support for [[SSL]]/[[TLS]] preread, which enabled nginx to inspect the initial `ClientHello` message of a TLS handshake without terminating the SSL session. This is useful for directing encrypted traffic based on the [SNI]( ((66f2bf22-3fb6-47aa-adbe-9edfa362ce6b)) ) field in TLS, allowing for
- Source
