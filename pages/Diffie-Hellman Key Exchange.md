- # Diffie-Hellman
	...
	- Using this method it is essential for both parties to never share their secrets without mixing it to guarantee they are the only ones who are able to create the shared secret. An observer is not able to create the shared secret because he does
	- ## Mathematics
		-
	-
- Source
