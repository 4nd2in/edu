...
- Because of this vulnerability, protocols using Diffie-Hellman additionally use authentication mechanism (e.g. [[RSA]]). The signed content of the key exchange thus implies that the public key is from the other
