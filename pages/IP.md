- # Internet Protocol (IP)
	...
	- ## RFC 791 - IPv4
		...
		- Instead of this dot-decimal representation you could use the compact CIDR notation. This specifies an IP address, a slash character and a decimal number. The decimal number represents the bits that indicate the network mask.
